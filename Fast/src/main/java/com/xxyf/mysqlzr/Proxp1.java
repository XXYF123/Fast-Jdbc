...
import com.xxyf.note.Insert;
import com.xxyf.note.Select;
 ...
 * @Version JDK 8
 */
public class Proxp1<T> implements InvocationHandler {
    Class<T> target;
    Mzr mzr;
    public Proxp1(Class<T> target,Mzr mzr){
        this.target=target;
        this.mzr=mzr;
    }
    ...
    public <T> T note(Method method,Mzr mzr,Object... param) {
        Select annotation = method.getAnnotation(Select.class);
        if (annotation == null) {
            Insert annotation1 = method.getAnnotation(Insert.class);
            if (annotation1 == null) {
                return null;
            }
